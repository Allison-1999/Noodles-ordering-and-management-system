 ...
 *  Intro: A control class control the actions of Home.fxml. It control the page switch of the business side
...
public class Controller implements Initializable {
    ...
    /**
     * Method Name: setPnlOverview()
     * Intro: initialize the overview page.
     */
